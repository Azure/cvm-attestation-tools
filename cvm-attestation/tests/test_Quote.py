...
class TestQuoteFactory:
  ...
  def test_roundtrip_v4_quote(self):
    header = b'\x04\x00' + b'\x02\x00' + b'\x81\x00\x00\x00' + b'\x00\x00' + b'\x00\x00' + b'\x01' * 16 + b'\x02' * 20
    body = b'\x03' * 584
  ...
  def test_roundtrip_v5_quote(self):
    header = b'\x05\x00' + b'\x02\x00' + b'\x81\x00\x00\x00' + b'\x00\x00' + b'\x00\x00' + b'\x01' * 16 + b'\x02' * 20
